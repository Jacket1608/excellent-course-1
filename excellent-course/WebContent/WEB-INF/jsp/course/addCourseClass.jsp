	...
	<div id="main">
		<form method="post" class="form form-x  form-tips" id="publishNews" onsubmit="return publishNews()">
			...
			<div class="form-group">
				...
				<div class="field">
					<textarea name="description" style="width: 750px; height: 500px;"></textarea>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			function publishNews(){
				...
				$.ajax({url:"${pageContext.request.contextPath}/course/publishCourseClass?date="+new Date().getTime(),data : postData,type:"POST",success:function(data){
					if(data.success){
