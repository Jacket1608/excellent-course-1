...
<div style="border-left:#00AA88 1em solid;padding-left: 5px;"><h1 style="display: inline-block;">新闻</h1> </div>
					...
					<c:forEach var="newsitem" items="${pager.datas }">
							...
							<div class="media media-x">
							  <a class='float-left' href="${pageContext.request.contextPath }/info/view/${newsitem.id}/news"> 
							  		<img src="${newsitem.images}" width="100px;" height="100ppx;" class="radius" alt="${newsitem.title}" title="${newsitem.title}">
							  </a>
							  <div class="media-body">
							    <strong> 
							    	标题：<a  href="${pageContext.request.contextPath }/info/view/${newsitem.id}/news"> ${newsitem.title}</a>
