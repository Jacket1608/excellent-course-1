...
<div id="main">
		<form action="" class="form form-x  form-tips" onsubmit="return addCourse()">
			<div class="form-group">
				...
				<div class="field">
					<input type="text" size="110" class="hidden" name="id" value="${course.id }"/>
					<input type="text" size="110" class="input" name="name" value="${course.name }"/>
				</div>
			</div>
				...
				<div class="field">
					<select class="input" name="courseLevel">
						...
						<c:forEach var="item" items="${courseLevels }">
							<option value="${item.id }" ${course.courseLevel.id==item.id?"selected":"" }>${item.name }</option>
						</c:forEach>
					</select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="field">
					<textarea name="description" style="width: 750px; height: 300px;">${course.description }</textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="field">
					<textarea name="teacherTeam" style="width: 750px; height: 300px;">${course.teacherTeam }</textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="field">
					<textarea name="teachContent" style="width: 750px; height: 300px;">${course.teachContent }</textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="field">
					<textarea name="teachMethod" style="width: 750px; height: 300px;">${course.teachMethod }</textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="field">
					<textarea name="teachEnvironment" style="width: 750px; height: 300px;">${course.teachEnvironment }</textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="field">
					<textarea name="teachOutline" style="width: 750px; height: 300px;">${course.teachOutline }</textarea>
				</div>
			</div>
	...
	KindEditor.ready(function(K) {
		...
		function addCourse() {
			...
			//提交数据
			$.ajax({
				url : "${pageContext.request.contextPath}/course/editCourse/"+id+"?date=" + new Date().getTime(),
