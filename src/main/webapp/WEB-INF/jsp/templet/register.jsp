	...
	<body>
		<div class="content">
			<div id="register_box">
				...
				<div id="main_box">
					<form class="register myregister" method="post" onsubmit=" return register()">
						<h1>注册</h1>
						<br />
						...
						<h2>email<span class="eemail error">${eEmail }</span></h2>
						<div class="text">
							<img src="${pageContext.request.contextPath }/commons/img/login/email.png" alt="email" />
							<input type="text" name="email" placeholder="Email Address" value="${email }"/><br />
						</div>
						...
						<h2>注册类型<span class="error">${euserType }</span></h2>
						<div class="text">
							<input type="radio" name="userType" value="student" checked="checked"/><label for="student">学生</label>&ensp;
							<input type="radio" name="userType" value="teacher"/><label for="teacher">教师</label>
						</div>	
