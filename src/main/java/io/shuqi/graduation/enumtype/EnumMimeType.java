...
public enum EnumMimeType {
	PDF("pdf", "commons/img/mimeType/reader.png"), 
	WORD("word", "commons/img/mimeType/word.png"), 
	EXECL("execl", "commons/img/mimeType/excel.png"), 
	POWERPOINT("powerpoint", "commons/img/mimeType/powerpoint.png"), 
	ACCESS("powerpoint", "commons/img/mimeType/access.png"),

	FOLDER("folder", "commons/img/mimeType/folder.png"), 
	ZIP("zip", "commons/img/mimeType/zip.png"), 
	RAR("rar", "commons/img/mimeType/rar.png"), 
	TEXT("text", "commons/img/mimeType/text.png"),

	WEBPAGE("webpage", "commons/img/mimeType/webpage.png"), 
	OTHER("other", "commons/img/mimeType/file.png"), 
	IMAGE("image", "commons/img/mimeType/image.png");
